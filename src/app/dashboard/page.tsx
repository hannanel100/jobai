    ...
    <div className="space-y-8">
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">
              {totalApplications === 0 ? 'No applications yet' : 'Applications submitted'}
            </p>
          </CardContent>
        </Card>
        <Card>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">{totalApplications > 0 ? `${successRate}%` : '-'}</div>
            <p className="text-xs text-muted-foreground">
                ...
                {applications.slice(0, 3).map((app) => (
                  <div key={app.id} className="flex justify-between items-center">
                    ...
                    <div className="text-right">
                      <p className="text-sm capitalize">{app.status.toLowerCase().replace('_', ' ')}</p>
                      <p className="text-xs text-muted-foreground">
