      ...
      try {
        ...
        parsedContent = {
          ...
          metadata: {
            ...
            producer: parsed.metadata?.producer || undefined,            creationDate: parsed.metadata?.creationDate && !isNaN(parsed.metadata.creationDate.getTime()) ? parsed.metadata.creationDate.toISOString() : undefined,          modificationDate: parsed.metadata?.modificationDate && !isNaN(parsed.metadata.modificationDate.getTime()) ? parsed.metadata.modificationDate.toISOString() : undefined,
          },
