...
import { Application, ApplicationSource } from '@prisma/client'
...
export function EditApplicationForm({ application }: EditApplicationFormProps) {
  ...
  const onSubmit = async (data: ApplicationUpdateData) => {
    setIsLoading(true)
    setError('')
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="space-y-2">
              ...
              <Select 
                onValueChange={(value) => setValue('applicationSource', value as ApplicationSource)}
                defaultValue={application.applicationSource || undefined}
              >
                <SelectTrigger>
